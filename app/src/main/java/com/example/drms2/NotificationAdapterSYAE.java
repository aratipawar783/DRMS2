...
public class NotificationAdapterSYAE extends ArrayAdapter<NotificationItemSYAE> {

    private Context context;
    private List<NotificationItemSYAE> notificationList;

    public NotificationAdapterSYAE(Context context, List<NotificationItemSYAE> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemSYAE notificationItem = notificationList.get(position);
