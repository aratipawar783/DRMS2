...
public class NotificationAdapterSYCE extends ArrayAdapter<NotificationItemSYCE> {

    private Context context;
    private List<NotificationItemSYCE> notificationList;

    public NotificationAdapterSYCE(Context context, List<NotificationItemSYCE> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemSYCE notificationItem = notificationList.get(position);
