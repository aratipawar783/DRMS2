...
public class NotificationAdapterSYEJ extends ArrayAdapter<NotificationItemSYEJ> {

    private Context context;
    private List<NotificationItemSYEJ> notificationList;

    public NotificationAdapterSYEJ(Context context, List<NotificationItemSYEJ> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemSYEJ notificationItem = notificationList.get(position);
