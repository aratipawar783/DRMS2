...
public class NotificationAdapterTYEE extends ArrayAdapter<NotificationItemTYEE> {

    private Context context;
    private List<NotificationItemTYEE> notificationList;

    public NotificationAdapterTYEE(Context context, List<NotificationItemTYEE> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemTYEE notificationItem = notificationList.get(position);
