...
public class NotificationAdapterTYME extends ArrayAdapter<NotificationItemTYME> {

    private Context context;
    private List<NotificationItemTYME> notificationList;

    public NotificationAdapterTYME(Context context, List<NotificationItemTYME> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemTYME notificationItem = notificationList.get(position);
