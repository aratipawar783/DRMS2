...
public class NotificationAdapterTYAE extends ArrayAdapter<NotificationItemTYAE> {

    private Context context;
    private List<NotificationItemTYAE> notificationList;

    public NotificationAdapterTYAE(Context context, List<NotificationItemTYAE> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemTYAE notificationItem = notificationList.get(position);
