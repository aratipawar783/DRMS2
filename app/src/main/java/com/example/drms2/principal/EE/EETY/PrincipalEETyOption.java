package com.example.drms2.principal.EE.EETY; // Change this to your actual package name
...
public class PrincipalEETyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalEETyOption.this,com.example.drms2.principal.EE.EETY.ViewTodayReportEETy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEETyOption.this,com.example.drms2.principal.EE.EETY.ViewHistoryEETy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEETyOption.this,com.example.drms2.principal.EE.EETY.ViewFeedbackEETy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalEETyOption.this, PrincipalEETYListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "TYEE Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYEE notificationItem = new NotificationItemTYEE(title, message, com.example.drms2.hod.EleHOD.TYEEReport.TyEEOptionActivity.class);
        NotificationManagerTYEE.getInstance(PrincipalEETyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerTYEE.getInstance(PrincipalEETyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalEETyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemTYEE> notifications = NotificationManagerTYEE.getInstance(PrincipalEETyOption.this).getNotifications();
