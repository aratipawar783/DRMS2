package com.example.drms2.principal.CM.CMTY; // Change this to your actual package name
...
import com.example.drms2.NotificationAdapterTYCM;
import com.example.drms2.NotificationItemTYCM;
import com.example.drms2.NotificationManagerTYCM;
import com.example.drms2.R;

import java.util.Calendar;
import java.util.List;

public class PrincipalCMTyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalCMTyOption.this,com.example.drms2.principal.CM.CMTY.ViewTodayReportCMTy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCMTyOption.this,com.example.drms2.principal.CM.CMTY.ViewHistoryCMTy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCMTyOption.this,com.example.drms2.principal.CM.CMTY.ViewFeedbackCMTy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalCMTyOption.this,PrincipalTYCMListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "TYCM Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYCM notificationItem = new NotificationItemTYCM(title, message,com.example.drms2.hod.CMHOD.TYCMReport.TyCMOptionActivity.class);
        NotificationManagerTYCM.getInstance(PrincipalCMTyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerTYCM.getInstance(PrincipalCMTyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalCMTyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemTYCM> notifications = NotificationManagerTYCM.getInstance(PrincipalCMTyOption.this).getNotifications();
        NotificationAdapterTYCM adapter = new NotificationAdapterTYCM(this, notifications);
