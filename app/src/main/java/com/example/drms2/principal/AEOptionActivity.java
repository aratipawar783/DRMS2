...
public class AEOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aeoption);
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AEOptionActivity.this,com.example.drms2.principal.AE.AEFY.PrincipalAEFYOption.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AEOptionActivity.this, com.example.drms2.principal.AE.AESY.PrincipalAESyOption.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AEOptionActivity.this, com.example.drms2.principal.AE.AETY.PrincipalAETyOption.class);
                    startActivity(intent);
                }
            }
        });
