...
public class ViewFeedbackCESy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_cesy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Civil Engineering Second Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackCESy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
