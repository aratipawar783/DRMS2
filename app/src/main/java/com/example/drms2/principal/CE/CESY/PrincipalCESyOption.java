package com.example.drms2.principal.CE.CESY; // Change this to your actual package name
...
public class PrincipalCESyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalCESyOption.this,com.example.drms2.principal.CE.CESY.ViewTodayReportCESy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCESyOption.this,com.example.drms2.principal.CE.CESY.ViewHistoryCESy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCESyOption.this,com.example.drms2.principal.CE.CESY.ViewFeedbackCESy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalCESyOption.this, PrincipalCESYListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "SYCE Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYCE notificationItem = new NotificationItemSYCE(title, message, com.example.drms2.hod.CivilHOD.SYCivilReport.SyCivilOptionActivity.class);
        NotificationManagerSYCE.getInstance(PrincipalCESyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerSYCE.getInstance(PrincipalCESyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalCESyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemSYCE> notifications = NotificationManagerSYCE.getInstance(PrincipalCESyOption.this).getNotifications();
        NotificationAdapterSYCE adapter = new NotificationAdapterSYCE(this, notifications);
