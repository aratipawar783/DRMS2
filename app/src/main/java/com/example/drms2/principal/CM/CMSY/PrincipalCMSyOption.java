package com.example.drms2.principal.CM.CMSY; // Change this to your actual package name
...
import com.example.drms2.NotificationAdapterSYCM;
import com.example.drms2.NotificationItemSYCM;
import com.example.drms2.NotificationManagerSYCM;
import com.example.drms2.R;

import java.util.Calendar;
import java.util.List;

public class PrincipalCMSyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalCMSyOption.this,com.example.drms2.principal.CM.CMSY.ViewTodayReportCMSy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCMSyOption.this,com.example.drms2.principal.CM.CMSY.ViewHistoryCMSy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCMSyOption.this,com.example.drms2.principal.CM.CMSY.ViewFeedbackCMSy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalCMSyOption.this, PrincipalSYCMListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "SYCM Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYCM notificationItem = new NotificationItemSYCM(title, message,com.example.drms2.hod.CMHOD.SYCMReport.SyCMOptionActivity.class);
        NotificationManagerSYCM.getInstance(PrincipalCMSyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerSYCM.getInstance(PrincipalCMSyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalCMSyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemSYCM> notifications = NotificationManagerSYCM.getInstance(PrincipalCMSyOption.this).getNotifications();
        NotificationAdapterSYCM adapter = new NotificationAdapterSYCM(this, notifications);
