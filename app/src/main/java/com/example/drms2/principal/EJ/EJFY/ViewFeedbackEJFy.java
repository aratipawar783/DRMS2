...
public class ViewFeedbackEJFy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_ejfy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Electronics and Telecommunication First Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackEJFy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
