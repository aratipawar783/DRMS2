package com.example.drms2.principal.AE.AESY; // Change this to your actual package name
...
import com.example.drms2.NotificationAdapterSYAE;
...
public class PrincipalAESyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalAESyOption.this,com.example.drms2.principal.AE.AESY.ViewTodayReportAutoSy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalAESyOption.this,com.example.drms2.principal.AE.AESY.ViewHistoryAutoSy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalAESyOption.this,com.example.drms2.principal.AE.AESY.ViewFeedbackAutoSy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalAESyOption.this, PrincipalAESYListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "SYAE Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYAE notificationItem = new NotificationItemSYAE(title, message, com.example.drms2.hod.AutoHOD.SYReport.SyAutoOptionActivity.class);
        NotificationManagerSYAE.getInstance(PrincipalAESyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerSYAE.getInstance(PrincipalAESyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalAESyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemSYAE> notifications = NotificationManagerSYAE.getInstance(PrincipalAESyOption.this).getNotifications();
        NotificationAdapterSYAE adapter = new NotificationAdapterSYAE(this, notifications);
