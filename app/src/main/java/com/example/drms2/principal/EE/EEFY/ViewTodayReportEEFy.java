...
public class ViewTodayReportEEFy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportEEFY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_eefy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrifyeeprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrifyeeprincipalForThird"); // Remove the saved URI
        editor.apply();
