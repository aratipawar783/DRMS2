package com.example.drms2.principal.ME.MEFY; // Change this to your actual package name
...
public class PrincipalMEFyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalMEFyOption.this,com.example.drms2.principal.ME.MEFY.ViewTodayReportMEFy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalMEFyOption.this,com.example.drms2.principal.ME.MEFY.ViewHistoryMEFy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalMEFyOption.this,com.example.drms2.principal.ME.MEFY.ViewFeedbackMEFy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalMEFyOption.this,PrincipalFYMEListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "FYME Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationManagerFYME.getInstance(PrincipalMEFyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerFYME.getInstance(PrincipalMEFyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalMEFyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemFYME> notifications = NotificationManagerFYME.getInstance(PrincipalMEFyOption.this).getNotifications();
        NotificationAdapterFYME adapter = new NotificationAdapterFYME(this, notifications);
