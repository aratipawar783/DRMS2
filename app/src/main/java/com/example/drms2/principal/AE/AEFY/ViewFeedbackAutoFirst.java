...
public class ViewFeedbackAutoFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_auto_fy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name1.equalsIgnoreCase("Automobile Engineering First Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackAutoFirst.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
