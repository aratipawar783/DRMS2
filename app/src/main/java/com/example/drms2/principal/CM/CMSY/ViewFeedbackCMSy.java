...
public class ViewFeedbackCMSy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_cmsy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Computer Technology Second Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackCMSy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
