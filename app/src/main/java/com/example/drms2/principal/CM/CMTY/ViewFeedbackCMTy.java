...
public class ViewFeedbackCMTy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_cmty); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Computer Technology Third Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackCMTy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
