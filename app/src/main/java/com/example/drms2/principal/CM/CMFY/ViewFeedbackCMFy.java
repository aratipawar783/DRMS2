...
public class ViewFeedbackCMFy extends AppCompatActivity {
    TextView  tvStudInfo, tvGetStudinfo;
    TableRow newRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_cmfy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Computer Technology First Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackCMFy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
