...
public class ViewFeedbackCETy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_cety); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Civil Engineering Third Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackCETy.this, "", Toast.LENGTH_SHORT).show();
                }
            }
        });
