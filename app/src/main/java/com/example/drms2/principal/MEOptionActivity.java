...
public class MEOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meoption2);
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(MEOptionActivity.this,com.example.drms2.principal.ME.MEFY.PrincipalMEFyOption.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(MEOptionActivity.this, com.example.drms2.principal.ME.MESY.PrincipalMESyOption.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(MEOptionActivity.this, com.example.drms2.principal.ME.METY.PrincipalMETyOption.class);
                    startActivity(intent);
                }
            }
        });
