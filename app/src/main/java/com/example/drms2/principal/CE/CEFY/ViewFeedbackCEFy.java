...
public class ViewFeedbackCEFy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_cefy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Civil Engineering First Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackCEFy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
