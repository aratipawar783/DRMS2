package com.example.drms2.principal.CM.CMFY; // Change this to your actual package name
...
import com.example.drms2.NotificationAdapterFYCM;
import com.example.drms2.NotificationItemFYCM;
import com.example.drms2.NotificationManagerFYCM;
import com.example.drms2.R;

import java.util.Calendar;
import java.util.List;

public class PrincipalCMFyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalCMFyOption.this,com.example.drms2.principal.CM.CMFY.ViewTodayReportCMFy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCMFyOption.this,com.example.drms2.principal.CM.CMFY.ViewHistoryCMFy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCMFyOption.this,com.example.drms2.principal.CM.CMFY.ViewFeedbackCMFy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalCMFyOption.this, PrincipalFYCMListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "FYCM Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYCM notificationItem = new NotificationItemFYCM(title, message, com.example.drms2.hod.CMHOD.FYCMReport.FyCMOptionActivity.class);
        NotificationManagerFYCM.getInstance(PrincipalCMFyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerFYCM.getInstance(PrincipalCMFyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalCMFyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemFYCM> notifications = NotificationManagerFYCM.getInstance(PrincipalCMFyOption.this).getNotifications();
        NotificationAdapterFYCM adapter = new NotificationAdapterFYCM(this, notifications);
