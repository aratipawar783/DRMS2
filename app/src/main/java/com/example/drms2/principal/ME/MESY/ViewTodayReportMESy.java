...
public class ViewTodayReportMESy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportMESY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_mesy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrisymeprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrisymeprincipalForThird"); // Remove the saved URI
        editor.apply();
