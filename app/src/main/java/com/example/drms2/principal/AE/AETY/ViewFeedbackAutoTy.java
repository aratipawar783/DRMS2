...
public class ViewFeedbackAutoTy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_auto_ty); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Automobile Engineering Third Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackAutoTy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
