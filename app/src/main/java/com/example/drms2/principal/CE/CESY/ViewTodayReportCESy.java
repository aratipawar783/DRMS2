package com.example.drms2.principal.CE.CESY;
...
public class ViewTodayReportCESy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportCESY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_by_sy_ce);
        ...
        String imageUriString = sharedPreferences.getString("imageUrisyceprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrisyceprincipalForThird"); // Remove the saved URI
        editor.apply();
