...
public class ViewTodayReportEJFy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportEJFY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_ejfy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrifyejprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrifyejprincipalForThird"); // Remove the saved URI
        editor.apply();
