...
public class ViewFeedbackEETy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_eety); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Electrical Engineering Third Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackEETy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
