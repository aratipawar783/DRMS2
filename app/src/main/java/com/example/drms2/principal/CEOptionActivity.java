...
public class CEOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ceoption);
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(CEOptionActivity.this,com.example.drms2.principal.CE.CEFY.PrincipalCEFyOption.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(CEOptionActivity.this, com.example.drms2.principal.CE.CESY.PrincipalCESyOption.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(CEOptionActivity.this, com.example.drms2.principal.CE.CETY.PrincipalCETyOption.class);
                    startActivity(intent);
                }
            }
        });
