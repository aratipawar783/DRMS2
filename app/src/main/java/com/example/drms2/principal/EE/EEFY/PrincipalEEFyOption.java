package com.example.drms2.principal.EE.EEFY; // Change this to your actual package name
...
public class PrincipalEEFyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalEEFyOption.this,com.example.drms2.principal.EE.EEFY.ViewTodayReportEEFy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEEFyOption.this,com.example.drms2.principal.EE.EEFY.ViewHistoryEEFy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEEFyOption.this,com.example.drms2.principal.EE.EEFY.ViewFeedbackEEFy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalEEFyOption.this,PrincipalEEFYListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "FYEE Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYEE notificationItem = new NotificationItemFYEE(title, message,com.example.drms2.hod.EleHOD.FYEEReport.FyEEOptionActivity.class);
        NotificationManagerFYEE.getInstance(PrincipalEEFyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerFYEE.getInstance(PrincipalEEFyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalEEFyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemFYEE> notifications = NotificationManagerFYEE.getInstance(this).getNotifications();
        NotificationAdapterFYEE adapter = new NotificationAdapterFYEE(this, notifications);
