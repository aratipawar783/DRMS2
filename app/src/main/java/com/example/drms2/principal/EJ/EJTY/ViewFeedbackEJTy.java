...
public class ViewFeedbackEJTy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_ejty); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Electronics and Telecommunication Third Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackEJTy.this, "No Report Found ", Toast.LENGTH_SHORT).show();
                }
            }
        });
