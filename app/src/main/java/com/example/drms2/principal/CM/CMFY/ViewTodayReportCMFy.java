...
public class ViewTodayReportCMFy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportCMFY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_cmfy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrifycmprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrifycmprincipalForThird"); // Remove the saved URI
        editor.apply();
