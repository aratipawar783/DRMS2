package com.example.drms2.principal.EE.EESY; // Change this to your actual package name
...
import com.example.drms2.NotificationAdapterSYEE;
import com.example.drms2.NotificationItemSYEE;
import com.example.drms2.NotificationManagerSYEE;
import com.example.drms2.R;

import java.util.Calendar;
import java.util.List;

public class PrincipalEESyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalEESyOption.this,com.example.drms2.principal.EE.EESY.ViewTodayReportEESy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEESyOption.this,com.example.drms2.principal.EE.EESY.ViewHistoryEESy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEESyOption.this,com.example.drms2.principal.EE.EESY.ViewFeedbackEESy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalEESyOption.this, PrincipalEESYListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "SYEE Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYEE notificationItem = new NotificationItemSYEE(title, message,com.example.drms2.hod.EleHOD.SYEEReport.SyEEOptionActivity.class);
        NotificationManagerSYEE.getInstance(PrincipalEESyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerSYEE.getInstance(PrincipalEESyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalEESyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemSYEE> notifications = NotificationManagerSYEE.getInstance(PrincipalEESyOption.this).getNotifications();
        NotificationAdapterSYEE adapter = new NotificationAdapterSYEE(this, notifications);
