package com.example.drms2.principal.CE.CETY; // Change this to your actual package name
...
import com.example.drms2.NotificationAdapterTYCE;
import com.example.drms2.NotificationItemTYCE;
import com.example.drms2.NotificationManagerTYCE;
import com.example.drms2.R;

import java.util.Calendar;
import java.util.List;

public class PrincipalCETyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalCETyOption.this,com.example.drms2.principal.CE.CETY.ViewTodayReportCETy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCETyOption.this,com.example.drms2.principal.CE.CETY.ViewHistoryCETy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCETyOption.this,com.example.drms2.principal.CE.CETY.ViewFeedbackCETy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalCETyOption.this,PrincipalCETYListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "TYCE Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYCE notificationItem = new NotificationItemTYCE(title, message,com.example.drms2.hod.CivilHOD.TYCivilReport.TyCivilOptionActivity.class);
        NotificationManagerTYCE.getInstance(PrincipalCETyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerTYCE.getInstance(PrincipalCETyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalCETyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemTYCE> notifications = NotificationManagerTYCE.getInstance(PrincipalCETyOption.this).getNotifications();
        NotificationAdapterTYCE adapter = new NotificationAdapterTYCE(this, notifications);
