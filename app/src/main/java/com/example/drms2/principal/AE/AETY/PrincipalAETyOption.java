package com.example.drms2.principal.AE.AETY; // Change this to your actual package name
...
public class PrincipalAETyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalAETyOption.this, PrincipalAutoTYListNotifications.class);
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalAETyOption.this,com.example.drms2.principal.AE.AETY.ViewTodayReportAutoTy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalAETyOption.this,com.example.drms2.principal.AE.AETY.ViewHistoryAutoTy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalAETyOption.this,com.example.drms2.principal.AE.AETY.ViewFeedbackAutoTy.class);
                    startActivity(intent);
                }
            }
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "FYAE Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYAE notificationItem = new NotificationItemTYAE(title, message, com.example.drms2.hod.AutoHOD.TYReport.TyAutoOptionActivity.class);
        NotificationManagerTYAE.getInstance(PrincipalAETyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerTYAE.getInstance(PrincipalAETyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalAETyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemTYAE> notifications = NotificationManagerTYAE.getInstance(PrincipalAETyOption.this).getNotifications();
        NotificationAdapterTYAE adapter = new NotificationAdapterTYAE(this, notifications);
