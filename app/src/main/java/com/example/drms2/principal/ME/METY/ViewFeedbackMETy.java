...
public class ViewFeedbackMETy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_mety); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Mechanical Engineering Third Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackMETy.this,"No Feedback Report Found",Toast.LENGTH_LONG).show();
                }
            }
        });
