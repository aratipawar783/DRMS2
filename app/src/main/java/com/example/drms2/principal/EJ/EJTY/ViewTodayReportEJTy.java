...
public class ViewTodayReportEJTy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportEJTY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_ejtfy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrityejprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrityejprincipalForThird"); // Remove the saved URI
        editor.apply();
