package com.example.drms2.principal.EJ.EJSY; // Change this to your actual package name
...
public class PrincipalEJSyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalEJSyOption.this,com.example.drms2.principal.EJ.EJSY.ViewTodayReportEJSy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEJSyOption.this,com.example.drms2.principal.EJ.EJSY.ViewHistoryEJSy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEJSyOption.this,com.example.drms2.principal.EJ.EJSY.ViewFeedbackEJSy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalEJSyOption.this, PrincipalSYEJListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "SYEJ Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYEJ notificationItem = new NotificationItemSYEJ(title, message, com.example.drms2.hod.EJHOD.SYEJReport.SyEJOptionActivity.class);
        NotificationManagerSYEJ.getInstance(PrincipalEJSyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerSYEJ.getInstance(PrincipalEJSyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalEJSyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemSYEJ> notifications = NotificationManagerSYEJ.getInstance(PrincipalEJSyOption.this).getNotifications();
        NotificationAdapterSYEJ adapter = new NotificationAdapterSYEJ(this, notifications);
