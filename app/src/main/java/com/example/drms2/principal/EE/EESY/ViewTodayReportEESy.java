...
public class ViewTodayReportEESy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportEESY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_eesy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrisyeeprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrisyeeprincipalForThird"); // Remove the saved URI
        editor.apply();
