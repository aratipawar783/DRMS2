...
public class ViewFeedbackEEFy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_eefy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Electrical Engineering First Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackEEFy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
