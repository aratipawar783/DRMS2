...
public class ViewTodayReportEETy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportEETY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_eety);
        ...
        String imageUriString = sharedPreferences.getString("imageUrityeeprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrityeeprincipalForThird"); // Remove the saved URI
        editor.apply();
