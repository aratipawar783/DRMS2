...
public class ViewTodayReportAutoFirst extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportAEfy";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_auto_first);
        ...
        String imageUriString = sharedPreferences.getString("imageUrifyaeprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrifyaeprincipalForThird"); // Remove the saved URI
        editor.apply();
