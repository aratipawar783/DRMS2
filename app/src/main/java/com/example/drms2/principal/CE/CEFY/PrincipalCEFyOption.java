package com.example.drms2.principal.CE.CEFY; // Change this to your actual package name
...
public class PrincipalCEFyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, menuItems);
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalCEFyOption.this,com.example.drms2.principal.CE.CEFY.ViewTodayReportCEFy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCEFyOption.this,com.example.drms2.principal.CE.CEFY.ViewHistoryCEFy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalCEFyOption.this,com.example.drms2.principal.CE.CEFY.ViewFeedbackCEFy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalCEFyOption.this,PrincipalCEFYListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "FYCE Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYCE notificationItem = new NotificationItemFYCE(title, message,com.example.drms2.hod.CivilHOD.FYCivilReport.FyCivilOptionActivity.class);
        NotificationManagerFYCE.getInstance(PrincipalCEFyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerFYCE.getInstance(PrincipalCEFyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalCEFyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemFYCE> notifications = NotificationManagerFYCE.getInstance(PrincipalCEFyOption.this).getNotifications();
        NotificationAdapterFYCE adapter = new NotificationAdapterFYCE(this, notifications);
