package com.example.drms2.principal.EJ.EJSY;
...
public class ViewTodayReportEJSy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportEJSY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_ejsy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrisyejprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrisyejprincipalForThird"); // Remove the saved URI
        editor.apply();
