package com.example.drms2.principal.EJ.EJFY; // Change this to your actual package name
...
public class PrincipalEJFyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalEJFyOption.this,com.example.drms2.principal.EJ.EJFY.ViewTodayReportEJFy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEJFyOption.this,com.example.drms2.principal.EJ.EJFY.ViewHistoryEJFy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalEJFyOption.this,com.example.drms2.principal.EJ.EJFY.ViewFeedbackEJFy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalEJFyOption.this,PrincipalFYEJListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "FYEJ Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYEJ notificationItem = new NotificationItemFYEJ(title, message, com.example.drms2.hod.EJHOD.FYEJReport.FyEJOptionActivity.class);
        NotificationManagerFYEJ.getInstance(PrincipalEJFyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerFYEJ.getInstance(PrincipalEJFyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalEJFyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemFYEJ> notifications = NotificationManagerFYEJ.getInstance(PrincipalEJFyOption.this).getNotifications();
        NotificationAdapterFYEJ adapter = new NotificationAdapterFYEJ(this, notifications);
