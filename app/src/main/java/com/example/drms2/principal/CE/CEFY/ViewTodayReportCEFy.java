package com.example.drms2.principal.CE.CEFY;
...
public class ViewTodayReportCEFy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportCEFY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_cefy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrifyceprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrifyceprincipalForThird"); // Remove the saved URI
        editor.apply();
