...
public class ViewTodayReportCETy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportCETY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_cety);
        ...
        String imageUriString = sharedPreferences.getString("imageUrityceprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrityceprincipalForThird"); // Remove the saved URI
        editor.apply();
