...
public class ViewFeedbackEJSy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_ejsy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Electronics and Telecommunication Second Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackEJSy.this, "No Report Found", Toast.LENGTH_SHORT).show();}
            }
        });
