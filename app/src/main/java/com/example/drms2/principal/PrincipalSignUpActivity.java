    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdminSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (confirm.equals("")) {
                    etxtPassword.setError("Please Re-enter password");
                    etxtConfirmPassword.requestFocus();
                    return;
                }

                boolean b=dbHelper.validatePrincipal(username,confirm);
                if (b && (password.equals(confirm))) {
                    Toast.makeText(PrincipalSignUpActivity.this, "You have already created an account...!", Toast.LENGTH_SHORT).show();
                    etxtConfirmPassword.setText("");
                    etxtPassword.setText("");
                    etxtUser.setText("");
                }else {
                    boolean b1 = dbHelper.insertPrincipalSignup(username, confirm);
                    if (b1 && (password.equals(confirm))) {
                        Toast.makeText(PrincipalSignUpActivity.this, "Sign_up Successful...!", Toast.LENGTH_SHORT).show();
                        etxtConfirmPassword.setText("");
                        etxtPassword.setText("");
                        etxtUser.setText("");
                        Intent intent=new Intent(PrincipalSignUpActivity.this, PrincipalDashboardActivity.class);
                        startActivity(intent);
                    }else
                    {
                        Toast.makeText(PrincipalSignUpActivity.this, "Sign-up Unsuccessful..!", Toast.LENGTH_SHORT).show();
