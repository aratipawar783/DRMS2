...
public class ViewTodayReportCMSy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportSYCM";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_cmsy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrisycmprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrisycmprincipalForThird"); // Remove the saved URI
        editor.apply();
