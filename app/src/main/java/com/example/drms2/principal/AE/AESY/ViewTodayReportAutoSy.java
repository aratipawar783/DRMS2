...
public class ViewTodayReportAutoSy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportAESY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_auto_sy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrisyaeprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrisyaeprincipalForThird"); // Remove the saved URI
        editor.apply();
