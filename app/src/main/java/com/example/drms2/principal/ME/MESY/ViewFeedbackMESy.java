...
public class ViewFeedbackMESy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_mesy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Mechanical Engineering Second Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackMESy.this, "No Feedback Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
