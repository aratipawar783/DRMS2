...
public class ViewFeedbackMEFy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_feedback_mefy); // Make sure to set your layout
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equalsIgnoreCase("Mechanical Engineering First Year")) {
                    fetchReport();
                }else {
                    Toast.makeText(ViewFeedbackMEFy.this, "No Report Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
