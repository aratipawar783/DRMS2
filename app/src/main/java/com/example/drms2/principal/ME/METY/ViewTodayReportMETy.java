...
public class ViewTodayReportMETy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportMETY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_mety);
        ...
        String imageUriString = sharedPreferences.getString("imageUritymeprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUritymeprincipalForThird"); // Remove the saved URI
        editor.apply();
