package com.example.drms2.principal.ME.MEFY;
...
public class ViewTodayReportMEFy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportMEFY";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_mefy);
        ...
        String imageUriString = sharedPreferences.getString("imageUrifymeprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUrifymeprincipalForThird"); // Remove the saved URI
        editor.apply();
