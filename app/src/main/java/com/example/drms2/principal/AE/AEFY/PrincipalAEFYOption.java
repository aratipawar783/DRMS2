package com.example.drms2.principal.AE.AEFY; // Change this to your actual package name
...
public class PrincipalAEFYOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalAEFYOption.this,com.example.drms2.principal.AE.AEFY.ViewTodayReportAutoFirst.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalAEFYOption.this,com.example.drms2.principal.AE.AEFY.ViewHistoryAutoFirst.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalAEFYOption.this,com.example.drms2.principal.AE.AEFY.ViewFeedbackAutoFirst.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalAEFYOption.this, FyAutoListNotificationsPrincipal.class);
            startActivity(intent);
        });
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYAE notificationItem = new NotificationItemFYAE(title, message, FyAutoListNotificationsPrincipal.class);
        NotificationManagerFYAE.getInstance(PrincipalAEFYOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerFYAE.getInstance(PrincipalAEFYOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalAEFYOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemFYAE> notifications = NotificationManagerFYAE.getInstance(PrincipalAEFYOption.this).getNotifications();
        NotificationAdapterFYAE adapter = new NotificationAdapterFYAE(this, notifications);
