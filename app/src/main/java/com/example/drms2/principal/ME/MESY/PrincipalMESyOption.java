package com.example.drms2.principal.ME.MESY; // Change this to your actual package name
...
import com.example.drms2.NotificationAdapterSYME;
import com.example.drms2.NotificationItemSYME;
import com.example.drms2.NotificationManagerSYME;
import com.example.drms2.R;

import java.util.Calendar;
import java.util.List;

public class PrincipalMESyOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(PrincipalMESyOption.this,com.example.drms2.principal.ME.MESY.ViewTodayReportMESy.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalMESyOption.this,com.example.drms2.principal.ME.MESY.ViewHistoryMESy.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(PrincipalMESyOption.this,com.example.drms2.principal.ME.MESY.ViewFeedbackMESy.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(PrincipalMESyOption.this, PrincipalSYMEListNotifications.class);
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Principal Sir", "SYME Report " + notificationStatus + " on " + selectedDate);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYME notificationItem = new NotificationItemSYME(title, message,com.example.drms2.hod.MEHOD.SYMEReport.SyMEOptionActivity.class);
        NotificationManagerSYME.getInstance(PrincipalMESyOption.this).addNotification(notificationItem);
    ...
    private void showNotificationDialog(int position) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", (dialog, which) -> {
                    ...
                    NotificationManagerSYME.getInstance(PrincipalMESyOption.this).getNotifications().remove(position);
                    Toast.makeText(PrincipalMESyOption.this, "Notification removed", Toast.LENGTH_SHORT).show();
    ...
    private void refreshNotificationList() {
        ...
        List<NotificationItemSYME> notifications = NotificationManagerSYME.getInstance(PrincipalMESyOption.this).getNotifications();
        NotificationAdapterSYME adapter = new NotificationAdapterSYME(this, notifications);
