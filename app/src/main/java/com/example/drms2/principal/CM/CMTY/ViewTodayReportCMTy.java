...
public class ViewTodayReportCMTy extends AppCompatActivity {
    ...
    private static final String TAG = "ViewTodayReportTYCM";
    Button btnClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_today_report_cmty);
        ...
        String imageUriString = sharedPreferences.getString("imageUritycmprincipalForThird", null);
    ...
    private void clearImage() {
        ...
        editor.remove("imageUritycmprincipalForThird"); // Remove the saved URI
        editor.apply();
