        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(EEoptionActivity.this,com.example.drms2.principal.EE.EEFY.PrincipalEEFyOption.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(EEoptionActivity.this, com.example.drms2.principal.EE.EESY.PrincipalEESyOption.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(EEoptionActivity.this, com.example.drms2.principal.EE.EETY.PrincipalEETyOption.class);
                    startActivity(intent);
                }
            }
        });
