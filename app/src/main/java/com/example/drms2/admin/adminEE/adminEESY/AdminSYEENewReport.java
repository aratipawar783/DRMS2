...
public class AdminSYEENewReport extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_syeenew_report);
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.takeScreenshotButton)
        {
            ...
            if (screenshot != null) {
                ...
                Intent intent = new Intent(AdminSYEENewReport.this,MiddleActivityEESY.class);
                intent.putExtra("screenshotsyee", byteArray);
