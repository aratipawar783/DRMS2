...
public class FYMEFeedback extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBFeedbackHelper(FYMEFeedback.this);
...
//                Toast.makeText(this, "Reports saved successfully!", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(FYMEFeedback.this, "Feedback saved successfully!", Toast.LENGTH_LONG).show();
