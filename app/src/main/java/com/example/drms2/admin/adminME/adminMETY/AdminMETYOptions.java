package com.example.drms2.admin.adminME.adminMETY; // Change this to your actual package name
...
public class AdminMETYOptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AdminMETYOptions.this, AdminTYMENewReport.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminMETYOptions.this, AdminTYMEHistory.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminMETYOptions.this,TYMEFeedback.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(AdminMETYOptions.this, AdminMETYListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemTYME clickedNotification = NotificationManagerTYME.getInstance(AdminMETYOptions.this).getNotifications().get(position);
            Intent intent = new Intent(AdminMETYOptions.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Third Year CC [Mechanical Engineering]", "Report Submitted on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationManagerTYME.getInstance(AdminMETYOptions.this).addNotification(notificationItem);
