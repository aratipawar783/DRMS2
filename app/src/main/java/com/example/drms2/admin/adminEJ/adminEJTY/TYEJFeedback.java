...
public class TYEJFeedback extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBFeedbackHelper(TYEJFeedback.this);
...
//                Toast.makeText(this, "Reports saved successfully!", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(TYEJFeedback.this, "Feedback saved successfully!", Toast.LENGTH_LONG).show();
