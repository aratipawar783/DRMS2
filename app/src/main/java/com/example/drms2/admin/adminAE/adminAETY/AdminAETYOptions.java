package com.example.drms2.admin.adminAE.adminAETY; // Change this to your actual package name
...
import com.example.drms2.hod.AutoHOD.TYReport.TyAutoOptionActivity;

import java.util.Calendar;

public class AdminAETYOptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AdminAETYOptions.this, AdminTYAENewReport.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminAETYOptions.this, AdminTYAEHistory.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminAETYOptions.this,TYAEFeedback.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(AdminAETYOptions.this, AdminAETYListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemTYAE clickedNotification = NotificationManagerTYAE.getInstance(AdminAETYOptions.this).getNotifications().get(position);
            Intent intent = new Intent(AdminAETYOptions.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Third Year CC [AutoMobile Engineering]", "Report Submitted on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYAE notificationItem = new NotificationItemTYAE(title, message, TyAutoOptionActivity.class);
        NotificationManagerTYAE.getInstance(AdminAETYOptions.this).addNotification(notificationItem);
