package com.example.drms2.admin.adminCM.adminSYCM; // Change this to your actual package name
...
public class AdminSYCMOptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AdminSYCMOptions.this, AdminSYCMNewReport.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminSYCMOptions.this, AdminSYCMHistory.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminSYCMOptions.this,SYCMFeedback.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(AdminSYCMOptions.this, AdminSYCMListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemSYCM clickedNotification = NotificationManagerSYCM.getInstance(AdminSYCMOptions.this).getNotifications().get(position);
            Intent intent = new Intent(AdminSYCMOptions.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Second Year CC [Computer Technology]", "Report Submitted on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationManagerSYCM.getInstance(AdminSYCMOptions.this).addNotification(notificationItem);
