...
public class AdminFYEENewReport extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_fyeenew_report);
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.takeScreenshotButton)
        {
            ...
            if (screenshot != null) {
                ...
                Intent intent = new Intent(AdminFYEENewReport.this,MiddleActivityEEFY.class);
                intent.putExtra("screenshotfyee", byteArray);
