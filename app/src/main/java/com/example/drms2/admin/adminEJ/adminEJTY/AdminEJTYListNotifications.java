...
public class AdminEJTYListNotifications extends AppCompatActivity {

    private ListView notificationListView;
    private NotificationAdapterTYEJ adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notifications = NotificationManagerTYEJ.getInstance(this).getNotifications();

        // Create and set the custom adapter for the ListView
        adapter = new NotificationAdapterTYEJ(this, notifications);
    ...
    private void showDeleteConfirmationDialog(int position) {
        ...
        NotificationItemTYEJ notificationToDelete = notifications.get(position);
    ...
    private void deleteNotification(int position) {
        ...
        NotificationManagerTYEJ.getInstance(this).updateNotifications(notifications); // Update the NotificationManager if needed
    }
}