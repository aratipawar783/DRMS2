package com.example.drms2.admin.adminEE.adminEETY; // Change this to your actual package name
...
public class AdminEETYOptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AdminEETYOptions.this, AdminTYEENewReport.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminEETYOptions.this, AdminTYEEHistory.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminEETYOptions.this,TYEEFeedback.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(AdminEETYOptions.this, AdminEETYListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemTYEE clickedNotification = NotificationManagerTYEE.getInstance(AdminEETYOptions.this).getNotifications().get(position);
            Intent intent = new Intent(AdminEETYOptions.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Third Year CC [Electrical Engineering]", "Report Submitted on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationManagerTYEE.getInstance(AdminEETYOptions.this).addNotification(notificationItem);
