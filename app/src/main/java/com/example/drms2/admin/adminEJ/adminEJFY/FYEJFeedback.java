...
public class FYEJFeedback extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBFeedbackHelper(FYEJFeedback.this);
...
//                Toast.makeText(this, "Reports saved successfully!", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(FYEJFeedback.this, "Feedback saved successfully!", Toast.LENGTH_LONG).show();
