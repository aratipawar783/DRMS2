...
public class AdminTYCENewReport extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_tycenew_report);
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.takeScreenshotButton)
        {
            ...
            if (screenshot != null) {
                ...
                Intent intent = new Intent(AdminTYCENewReport.this,MiddleActivityTYCE.class);
                intent.putExtra("screenshottyce", byteArray);
