package com.example.drms2.admin.adminAE.adminAESY; // Change this to your actual package name
...
public class AdminAESYOptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AdminAESYOptions.this,AdminSYAENewReport.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminAESYOptions.this, AdminSYAEHistory.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminAESYOptions.this,SYAEFeedback.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(AdminAESYOptions.this, AdminAESYListNotification.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemSYAE clickedNotification = NotificationManagerSYAE.getInstance(AdminAESYOptions.this).getNotifications().get(position);
            Intent intent = new Intent(AdminAESYOptions.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from Second Year CC [Automobile Engineering]", "Report Submitted on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationManagerSYAE.getInstance(AdminAESYOptions.this).addNotification(notificationItem);
