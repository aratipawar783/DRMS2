package com.example.drms2.admin.adminCM.adminFYCM; // Change this to your actual package name
...
public class AdminFYCMOptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AdminFYCMOptions.this, AdminFYCMNewReport.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminFYCMOptions.this, AdminFYCMHistory.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminFYCMOptions.this,FYCMFeedback.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(AdminFYCMOptions.this, AdminFYCMListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYCM clickedNotification = NotificationManagerFYCM.getInstance(AdminFYCMOptions.this).getNotifications().get(position);
            Intent intent = new Intent(AdminFYCMOptions.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from First Year CC [Computer Technology]", "Report Submitted on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationManagerFYCM.getInstance(AdminFYCMOptions.this).addNotification(notificationItem);
