package com.example.drms2.admin.adminEE.adminEEFY; // Change this to your actual package name
...
public class AdminEEFYOptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AdminEEFYOptions.this, AdminFYEENewReport.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminEEFYOptions.this, AdminFYEEHistory.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminEEFYOptions.this,FYEEFeedback.class);
                    startActivity(intent);
                }
            }
        });
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(AdminEEFYOptions.this, AdminEEFYListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYEE clickedNotification = NotificationManagerFYEE.getInstance(AdminEEFYOptions.this).getNotifications().get(position);
            Intent intent = new Intent(AdminEEFYOptions.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from First Year CC [Electrical Engineering]", "Report Submitted on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationManagerFYEE.getInstance(AdminEEFYOptions.this).addNotification(notificationItem);
