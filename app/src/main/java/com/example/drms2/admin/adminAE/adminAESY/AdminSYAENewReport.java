...
public class AdminSYAENewReport extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_syaenew_report);
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.takeScreenshotButton)
        {
            ...
            if (screenshot != null) {
                ...
                Intent intent = new Intent(AdminSYAENewReport.this,MiddleActivitySYAE.class);
                intent.putExtra("screenshotsyae", byteArray);
