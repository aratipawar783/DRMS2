...
public class SYEJFeedback extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBFeedbackHelper(SYEJFeedback.this);
...
//                Toast.makeText(this, "Reports saved successfully!", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(SYEJFeedback.this, "Feedback saved successfully!", Toast.LENGTH_LONG).show();
