...
public class SYCMFeedback extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBFeedbackHelper(SYCMFeedback.this);
...
//                Toast.makeText(this, "Reports saved successfully!", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(SYCMFeedback.this, "Feedback saved successfully!", Toast.LENGTH_LONG).show();
