...
public class AdminFYAENewReport extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_fyaenew_report);
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.takeScreenshotButton)
        {
            ...
            if (screenshot != null) {
                ...
                Intent intent = new Intent(AdminFYAENewReport.this,MiddleActvivityFYAE.class);
                intent.putExtra("screenshotfyae", byteArray);
