package com.example.drms2.admin.adminCE.adminCEFY; // Change this to your actual package name
...
public class AdminCEFYOptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(AdminCEFYOptions.this,AdminFYCEListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYCE clickedNotification = NotificationManagerFYCE.getInstance(AdminCEFYOptions.this).getNotifications().get(position);
            Intent intent = new Intent(AdminCEFYOptions.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AdminCEFYOptions.this, AdminFYCENewReport.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminCEFYOptions.this, AdminFYCEHistory.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AdminCEFYOptions.this,FYCEFeedback.class);
                    startActivity(intent);
                }
            }
        });
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from First Year CC [Civil Engineering]", "Report Submitted on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationManagerFYCE.getInstance(AdminCEFYOptions.this).addNotification(notificationItem);
