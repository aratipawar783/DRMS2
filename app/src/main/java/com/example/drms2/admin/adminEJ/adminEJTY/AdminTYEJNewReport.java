...
public class AdminTYEJNewReport extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.takeScreenshotButton)
        {
            ...
            if (screenshot != null) {
                ...
                Intent intent = new Intent(AdminTYEJNewReport.this,MiddleActivityEJTY.class);
                intent.putExtra("screenshottyej", byteArray);
