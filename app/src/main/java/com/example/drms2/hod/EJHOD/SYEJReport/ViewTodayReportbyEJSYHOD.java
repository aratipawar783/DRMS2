package com.example.drms2.hod.EJHOD.SYEJReport;
...
public class ViewTodayReportbyEJSYHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_reportby_ejsyhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrisyejForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrisyejprincipalForThird", imageUri.toString());
            editor.apply();
