...
public class ViewTodayReportbyMEFYHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_reportby_mefyhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrifymeForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrifymeprincipalForThird", imageUri.toString());
            editor.apply();
