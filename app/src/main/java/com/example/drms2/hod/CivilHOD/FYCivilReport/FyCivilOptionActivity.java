package com.example.drms2.hod.CivilHOD.FYCivilReport; // Change this to your actual package name
...
public class FyCivilOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(FyCivilOptionActivity.this, ViewTodayReportByFYCEHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(FyCivilOptionActivity.this, FYCivilHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(FyCivilOptionActivity.this,FyCivilOptionActivityListNotifications.class);
            startActivity(intent);
        });
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYCE clickedNotification = NotificationManagerFYCE.getInstance(FyCivilOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(FyCivilOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYCE notificationItem = new NotificationItemFYCE(title, message,com.example.drms2.admin.adminCE.adminCEFY.AdminCEFYOptions.class);
        NotificationManagerFYCE.getInstance(FyCivilOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemFYCE> notifications = NotificationManagerFYCE.getInstance(FyCivilOptionActivity.this).getNotifications();
