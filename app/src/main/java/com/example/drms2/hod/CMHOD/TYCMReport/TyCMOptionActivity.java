package com.example.drms2.hod.CMHOD.TYCMReport; // Change this to your actual package name
...
import com.example.drms2.hod.CivilHOD.TYCivilReport.TYCivilListNotifications;

import java.util.Calendar;
import java.util.List;

public class TyCMOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(TyCMOptionActivity.this, ViewTodaysReportByTYCMHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(TyCMOptionActivity.this, TYCMHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(TyCMOptionActivity.this, TYCMListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemTYCM clickedNotification = NotificationManagerTYCM.getInstance(TyCMOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(TyCMOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void showDatePickerDialog(String status) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from HOD [Computer Technology]", status + " on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYCM notificationItem = new NotificationItemTYCM(title, message, com.example.drms2.admin.adminCM.adminTYCM.AdminTYCMOptions.class);
        NotificationManagerTYCM.getInstance(TyCMOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemTYCM> notifications = NotificationManagerTYCM.getInstance(TyCMOptionActivity.this).getNotifications();
