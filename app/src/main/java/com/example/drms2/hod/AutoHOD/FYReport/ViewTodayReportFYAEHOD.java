package com.example.drms2.hod.AutoHOD.FYReport;
...
public class ViewTodayReportFYAEHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_fyaehod);
        ...
        String imagePath = sharedPreferences.getString("imageUrifyaeForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrifyaeprincipalForThird", imageUri.toString());
            editor.apply();
