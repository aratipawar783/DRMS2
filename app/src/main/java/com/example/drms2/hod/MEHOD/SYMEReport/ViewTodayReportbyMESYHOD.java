...
public class ViewTodayReportbyMESYHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_reportby_mesyhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrisymeForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrisymeprincipalForThird", imageUri.toString());
            editor.apply();
