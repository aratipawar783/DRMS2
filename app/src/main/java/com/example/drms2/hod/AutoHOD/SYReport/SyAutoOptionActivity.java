package com.example.drms2.hod.AutoHOD.SYReport; // Change this to your actual package name
...
public class SyAutoOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(SyAutoOptionActivity.this, ViewTodayReportBySYAEHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(SyAutoOptionActivity.this, SYAutoHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(SyAutoOptionActivity.this, SyAutoListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemSYAE clickedNotification = NotificationManagerSYAE.getInstance(SyAutoOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(SyAutoOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    private void showDatePickerDialog(String status) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from HOD [Automobile Engineering]", status + " on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYAE notificationItem = new NotificationItemSYAE(title, message,com.example.drms2.admin.adminAE.adminAESY.AdminAESYOptions.class);
        NotificationManagerSYAE.getInstance(SyAutoOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemSYAE> notifications = NotificationManagerSYAE.getInstance(SyAutoOptionActivity.this).getNotifications();
