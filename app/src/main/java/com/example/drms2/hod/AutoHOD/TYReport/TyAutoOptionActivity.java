package com.example.drms2.hod.AutoHOD.TYReport; // Change this to your actual package name
...
public class TyAutoOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(TyAutoOptionActivity.this,ViewTodayReportBYTYAEHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(TyAutoOptionActivity.this, TYAutoHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(TyAutoOptionActivity.this, TyAutoListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemTYAE clickedNotification = NotificationManagerTYAE.getInstance(TyAutoOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(TyAutoOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYAE notificationItem = new NotificationItemTYAE(title, message,com.example.drms2.admin.adminAE.adminAETY.AdminAETYOptions.class);
        NotificationManagerTYAE.getInstance(TyAutoOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemTYAE> notifications = NotificationManagerTYAE.getInstance(TyAutoOptionActivity.this).getNotifications();
