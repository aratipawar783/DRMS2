        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(CMOptionActivity.this,com.example.drms2.hod.CMHOD.FYCMReport.FyCMOptionActivity.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(CMOptionActivity.this, com.example.drms2.hod.CMHOD.SYCMReport.SyCMOptionActivity.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(CMOptionActivity.this, com.example.drms2.hod.CMHOD.TYCMReport.TyCMOptionActivity.class);
                    startActivity(intent);
                }
            }
        });
