package com.example.drms2.hod.CivilHOD.SYCivilReport; // Change this to your actual package name
...
public class SyCivilOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(SyCivilOptionActivity.this, ViewTodayReportBYSYCEHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(SyCivilOptionActivity.this, SYCivilHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(SyCivilOptionActivity.this,SYCivilListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemSYCE clickedNotification = NotificationManagerSYCE.getInstance(SyCivilOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(SyCivilOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYCE notificationItem = new NotificationItemSYCE(title, message,com.example.drms2.admin.adminCE.adminCESY.AdminCESYOptions.class);
        NotificationManagerSYCE.getInstance(SyCivilOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemSYCE> notifications = NotificationManagerSYCE.getInstance(SyCivilOptionActivity.this).getNotifications();
