package com.example.drms2.hod.EJHOD.SYEJReport; // Change this to your actual package name
...
public class SyEJOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(SyEJOptionActivity.this, ViewTodayReportbyEJSYHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(SyEJOptionActivity.this, SYEJHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(SyEJOptionActivity.this, SYEJListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemSYEJ clickedNotification = NotificationManagerSYEJ.getInstance(SyEJOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(SyEJOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void showDatePickerDialog(String status) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from HOD [Electronics And Telecommunication]", status + " on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYEJ notificationItem = new NotificationItemSYEJ(title, message, com.example.drms2.admin.adminEJ.adminEJSY.AdminSYEJOptions.class);
        NotificationManagerSYEJ.getInstance(SyEJOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemSYEJ> notifications = NotificationManagerSYEJ.getInstance(SyEJOptionActivity.this).getNotifications();
