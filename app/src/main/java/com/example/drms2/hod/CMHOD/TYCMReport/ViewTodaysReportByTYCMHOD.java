...
public class ViewTodaysReportByTYCMHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_todays_report_by_tycmhod);
        ...
        String imagePath = sharedPreferences.getString("imageUritycmForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUritycmprincipalForThird", imageUri.toString());
            editor.apply();
