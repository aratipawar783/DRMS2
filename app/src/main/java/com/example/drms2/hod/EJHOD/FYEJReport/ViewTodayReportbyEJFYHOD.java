package com.example.drms2.hod.EJHOD.FYEJReport;
...
public class ViewTodayReportbyEJFYHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_reportby_ejfyhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrifyejForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrifyejprincipalForThird", imageUri.toString());
            editor.apply();
