package com.example.drms2.hod.MEHOD.SYMEReport; // Change this to your actual package name
...
public class SyMEOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(SyMEOptionActivity.this, ViewTodayReportbyMESYHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(SyMEOptionActivity.this, SYMEHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(SyMEOptionActivity.this, SYMEListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemSYME clickedNotification = NotificationManagerSYME.getInstance(SyMEOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(SyMEOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void showDatePickerDialog(String status) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from HOD [Mechanical Engineering]", status + " on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYME notificationItem = new NotificationItemSYME(title, message, com.example.drms2.admin.adminME.adminMESY.AdminMESYOptions.class);
        NotificationManagerSYME.getInstance(SyMEOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemSYME> notifications = NotificationManagerSYME.getInstance(SyMEOptionActivity.this).getNotifications();
