package com.example.drms2.hod.EleHOD.FYEEReport;
...
public class ViewTodayReportbyEEFYHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_reportby_eefyhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrifyeeForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrifyeeprincipalForThird", imageUri.toString());
            editor.apply();
