...
public class ViewTodaysReportByFYCMHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_todays_report_by_fycmhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrifycmForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrifycmprincipalForThird", imageUri.toString());
            editor.apply();
