package com.example.drms2.hod.MEHOD.TYMEReport; // Change this to your actual package name
...
public class TyMEOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(TyMEOptionActivity.this, ViewTodayReportbyMETYHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(TyMEOptionActivity.this, TYMEHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(TyMEOptionActivity.this, TYMEListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemTYME clickedNotification = NotificationManagerTYME.getInstance(TyMEOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(TyMEOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYME notificationItem = new NotificationItemTYME(title, message, com.example.drms2.admin.adminME.adminMETY.AdminMETYOptions.class);
        NotificationManagerTYME.getInstance(TyMEOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemTYME> notifications = NotificationManagerTYME.getInstance(TyMEOptionActivity.this).getNotifications();
