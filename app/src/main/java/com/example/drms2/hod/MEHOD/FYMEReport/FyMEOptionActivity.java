package com.example.drms2.hod.MEHOD.FYMEReport; // Change this to your actual package name
...
public class FyMEOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(FyMEOptionActivity.this, ViewTodayReportbyMEFYHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(FyMEOptionActivity.this, FYMEHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(FyMEOptionActivity.this, FYMEListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYME clickedNotification = NotificationManagerFYME.getInstance(FyMEOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(FyMEOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYME notificationItem = new NotificationItemFYME(title, message, com.example.drms2.admin.adminME.adminMEFY.AdminMEFYOptions.class);
        NotificationManagerFYME.getInstance(FyMEOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemFYME> notifications = NotificationManagerFYME.getInstance(FyMEOptionActivity.this).getNotifications();
