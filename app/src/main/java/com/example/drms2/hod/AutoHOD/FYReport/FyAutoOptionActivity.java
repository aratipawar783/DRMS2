package com.example.drms2.hod.AutoHOD.FYReport; // Change this to your actual package name
...
public class FyAutoOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(FyAutoOptionActivity.this, ViewTodayReportFYAEHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(FyAutoOptionActivity.this, FYAutoHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(FyAutoOptionActivity.this, FyAutoListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYAE clickedNotification = NotificationManagerFYAE.getInstance(FyAutoOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(FyAutoOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYAE notificationItem = new NotificationItemFYAE(title, message,com.example.drms2.admin.adminAE.adminAESY.AdminAESYOptions.class);
        NotificationManagerFYAE.getInstance(FyAutoOptionActivity.this).addNotification(notificationItem);
