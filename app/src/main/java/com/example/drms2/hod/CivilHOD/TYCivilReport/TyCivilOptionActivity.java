package com.example.drms2.hod.CivilHOD.TYCivilReport; // Change this to your actual package name
...
public class TyCivilOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(TyCivilOptionActivity.this, ViewTodayReportByTYCEHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(TyCivilOptionActivity.this, TYCivilHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(TyCivilOptionActivity.this, TYCivilListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemTYCE clickedNotification = NotificationManagerTYCE.getInstance(TyCivilOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(TyCivilOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    private void showDatePickerDialog(String status) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, selectedYear, selectedMonth, selectedDay) -> {
            ...
            sendNotification("Notification from HOD [Civil Engineering]", status + " on " + date);
        }, year, month, day);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYCE notificationItem = new NotificationItemTYCE(title, message, com.example.drms2.admin.adminCE.adminCESY.AdminCESYOptions.class);
        NotificationManagerTYCE.getInstance(TyCivilOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemTYCE> notifications = NotificationManagerTYCE.getInstance(TyCivilOptionActivity.this).getNotifications();
