...
public class HODSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdminSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean b=dbHelper.validateHOD(username,confirm);
                if (b && (password.equals(confirm))) {
                    Toast.makeText(HODSignUpActivity.this, "You have already created an account...!", Toast.LENGTH_SHORT).show();
                    etxtConfirmPassword.setText("");
                    etxtPassword.setText("");
                    etxtUser.setText("");
                }else {
                    boolean b1 = dbHelper.insertHODSignup(username, confirm);
                    if (b1 && (password.equals(confirm))) {
                        Toast.makeText(HODSignUpActivity.this, "Sign_up Successful...!", Toast.LENGTH_SHORT).show();
                        etxtConfirmPassword.setText("");
                        etxtPassword.setText("");
                        etxtUser.setText("");
                        Intent intent=new Intent(HODSignUpActivity.this, MainHODDashboardActivity.class);
                        startActivity(intent);
                    }else
                    {
                        Toast.makeText(HODSignUpActivity.this, "Sign-up Unsuccessful..!", Toast.LENGTH_SHORT).show();
