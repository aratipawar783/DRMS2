package com.example.drms2.hod.EleHOD.SYEEReport; // Change this to your actual package name
...
public class SyEEOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(SyEEOptionActivity.this, ViewTodayReportbyEESYHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(SyEEOptionActivity.this, SYEEHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(SyEEOptionActivity.this,SYEEListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemSYEE clickedNotification = NotificationManagerSYEE.getInstance(SyEEOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(SyEEOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYEE notificationItem = new NotificationItemSYEE(title, message, com.example.drms2.admin.adminEE.adminEESY.AdminEESYOptions.class);
        NotificationManagerSYEE.getInstance(SyEEOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemSYEE> notifications = NotificationManagerSYEE.getInstance(SyEEOptionActivity.this).getNotifications();
