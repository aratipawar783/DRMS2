package com.example.drms2.hod.EleHOD.TYEEReport;
...
public class ViewTodayReportbyEETYHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_reportby_eetyhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrityeeForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrityeeprincipalForThird", imageUri.toString());
            editor.apply();
