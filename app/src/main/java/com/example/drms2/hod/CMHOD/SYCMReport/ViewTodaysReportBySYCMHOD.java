...
public class ViewTodaysReportBySYCMHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_todays_report_by_sycmhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrisycmForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrisycmprincipalForThird", imageUri.toString());
            editor.apply();
