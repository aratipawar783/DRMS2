package com.example.drms2.hod.CivilHOD.SYCivilReport;
...
public class ViewTodayReportBYSYCEHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_bysycehod);
        ...
        String imagePath = sharedPreferences.getString("imageUrisyceForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrisyceprincipalForThird", imageUri.toString());
            editor.apply();
