...
public class EJOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejoption);
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(EJOptionActivity.this,com.example.drms2.hod.EJHOD.FYEJReport.FyEJOptionActivity.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(EJOptionActivity.this, com.example.drms2.hod.EJHOD.SYEJReport.SyEJOptionActivity.class);
                    startActivity(intent);

                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(EJOptionActivity.this, com.example.drms2.hod.EJHOD.TYEJReport.TyEJOptionActivity.class);
                    startActivity(intent);
