...
public class ViewTodayReportBySYAEHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_by_syaehod);
        ...
        String imagePath = sharedPreferences.getString("imageUrisyaeForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrisyaeprincipalForThird", imageUri.toString());
            editor.apply();
