...
public class ViewTodayReportByFYCEHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_by_fycehod);
        ...
        String imagePath = sharedPreferences.getString("imageUrifyceForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrifyceprincipalForThird", imageUri.toString());
            editor.apply();
