package com.example.drms2.hod.AutoHOD.SYReport;
...
public class SyAutoListNotifications extends AppCompatActivity {

    private ListView notificationListView;
    private NotificationAdapterSYAE adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notifications = NotificationManagerSYAE.getInstance(this).getNotifications();

        // Create and set the custom adapter for the ListView
        adapter = new NotificationAdapterSYAE(this, notifications);
    ...
    private void showDeleteConfirmationDialog(int position) {
        ...
        NotificationItemSYAE notificationToDelete = notifications.get(position);
    ...
    private void deleteNotification(int position) {
        ...
        NotificationManagerSYAE.getInstance(this).updateNotifications(notifications); // Update the NotificationManager if needed
    }
}