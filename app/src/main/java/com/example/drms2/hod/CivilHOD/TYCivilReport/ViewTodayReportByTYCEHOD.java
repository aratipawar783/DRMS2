...
public class ViewTodayReportByTYCEHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_by_tycehod);
        ...
        String imagePath = sharedPreferences.getString("imageUrityceForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrityceprincipalForThird", imageUri.toString());
            editor.apply();
