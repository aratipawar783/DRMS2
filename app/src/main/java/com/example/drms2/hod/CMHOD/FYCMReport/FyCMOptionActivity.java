package com.example.drms2.hod.CMHOD.FYCMReport; // Change this to your actual package name
...
public class FyCMOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(FyCMOptionActivity.this, ViewTodaysReportByFYCMHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(FyCMOptionActivity.this, FYCMHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(FyCMOptionActivity.this, FYCMListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYCM clickedNotification = NotificationManagerFYCM.getInstance(FyCMOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(FyCMOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYCM notificationItem = new NotificationItemFYCM(title, message, com.example.drms2.admin.adminCM.adminFYCM.AdminFYCMOptions.class);
        NotificationManagerFYCM.getInstance(FyCMOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemFYCM> notifications = NotificationManagerFYCM.getInstance(FyCMOptionActivity.this).getNotifications();
