package com.example.drms2.hod.EJHOD.TYEJReport; // Change this to your actual package name
...
public class TyEJOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(TyEJOptionActivity.this, ViewTodayReportbyEJTYHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(TyEJOptionActivity.this, TYEJHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(TyEJOptionActivity.this, TYEJListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemTYEJ clickedNotification = NotificationManagerTYEJ.getInstance(TyEJOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(TyEJOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemTYEJ notificationItem = new NotificationItemTYEJ(title, message, com.example.drms2.admin.adminEJ.adminEJTY.AdminTYEJOptions.class);
        NotificationManagerTYEJ.getInstance(TyEJOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemTYEJ> notifications = NotificationManagerTYEJ.getInstance(TyEJOptionActivity.this).getNotifications();
