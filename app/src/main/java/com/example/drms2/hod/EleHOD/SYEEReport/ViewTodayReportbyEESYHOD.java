...
public class ViewTodayReportbyEESYHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_reportby_eesyhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrisyeeForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrisyeeprincipalForThird", imageUri.toString());
            editor.apply();
