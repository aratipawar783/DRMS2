...
public class ViewTodayReportbyEJTYHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_reportby_ejtyhod);
        ...
        String imagePath = sharedPreferences.getString("imageUrityejForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrityejprincipalForThird", imageUri.toString());
            editor.apply();
