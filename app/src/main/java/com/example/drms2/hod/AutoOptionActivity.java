...
public class AutoOptionActivity extends AppCompatActivity {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(AutoOptionActivity.this,com.example.drms2.hod.AutoHOD.FYReport.FyAutoOptionActivity.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(AutoOptionActivity.this, com.example.drms2.hod.AutoHOD.SYReport.SyAutoOptionActivity.class);
                    startActivity(intent);
                }
                else if (position == 2) {
                    // Handle History menu item click
                    Intent intent = new Intent(AutoOptionActivity.this, com.example.drms2.hod.AutoHOD.TYReport.TyAutoOptionActivity.class);
                    startActivity(intent);
                }
            }
        });
