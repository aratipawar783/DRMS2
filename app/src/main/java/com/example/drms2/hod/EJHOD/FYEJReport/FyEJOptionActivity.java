package com.example.drms2.hod.EJHOD.FYEJReport; // Change this to your actual package name
...
public class FyEJOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(FyEJOptionActivity.this, ViewTodayReportbyEJFYHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(FyEJOptionActivity.this, FYEJHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(FyEJOptionActivity.this, FYEJListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYEJ clickedNotification = NotificationManagerFYEJ.getInstance(FyEJOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(FyEJOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYEJ notificationItem = new NotificationItemFYEJ(title, message, com.example.drms2.admin.adminEJ.adminEJFY.AdminFYEJOptions.class);
        NotificationManagerFYEJ.getInstance(FyEJOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemFYEJ> notifications = NotificationManagerFYEJ.getInstance(FyEJOptionActivity.this).getNotifications();
