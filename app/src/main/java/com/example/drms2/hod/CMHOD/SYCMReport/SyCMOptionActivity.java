package com.example.drms2.hod.CMHOD.SYCMReport; // Change this to your actual package name
...
public class SyCMOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(SyCMOptionActivity.this,ViewTodaysReportBySYCMHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(SyCMOptionActivity.this, SYCMHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(SyCMOptionActivity.this, SYCMListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemSYCM clickedNotification = NotificationManagerSYCM.getInstance(SyCMOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(SyCMOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemSYCM notificationItem = new NotificationItemSYCM(title, message,com.example.drms2.admin.adminCM.adminSYCM.AdminSYCMOptions.class);
        NotificationManagerSYCM.getInstance(SyCMOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemSYCM> notifications = NotificationManagerSYCM.getInstance(SyCMOptionActivity.this).getNotifications();
