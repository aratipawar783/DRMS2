package com.example.drms2.hod.AutoHOD.TYReport;
...
public class ViewTodayReportBYTYAEHOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_today_report_bytyaehod);
        ...
        String imagePath = sharedPreferences.getString("imageUrityaeForMiddle", null);
        if (imagePath != null) {
    ...
    private void sendImageToNextActivity() {
        ...
        if (imagePath != null) {
            ...
            editor.putString("imageUrityaeprincipalForThird", imageUri.toString());
            editor.apply();
