package com.example.drms2.hod.EleHOD.FYEEReport; // Change this to your actual package name
...
public class FyEEOptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Intent intent = new Intent(FyEEOptionActivity.this, ViewTodayReportbyEEFYHOD.class);
                    startActivity(intent);
                } else if (position == 1) {
                    // Handle History menu item click
                    Intent intent = new Intent(FyEEOptionActivity.this, FYEEHistoryActivity.class);
                    startActivity(intent);
                }
        ...
        displayNotificationButton.setOnClickListener(view -> {
            Intent intent = new Intent(FyEEOptionActivity.this,FYEEListNotifications.class);
            startActivity(intent);
        });

        // Handle item click in ListView to navigate
        notificationListView.setOnItemClickListener((parent, view, position, id) -> {
            NotificationItemFYEE clickedNotification = NotificationManagerFYEE.getInstance(FyEEOptionActivity.this).getNotifications().get(position);
            Intent intent = new Intent(FyEEOptionActivity.this, clickedNotification.getActivityClass());
            startActivity(intent);
        });
    }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationItemFYEE notificationItem = new NotificationItemFYEE(title, message,com.example.drms2.admin.adminEE.adminEEFY.AdminEEFYOptions.class);
        NotificationManagerFYEE.getInstance(FyEEOptionActivity.this).addNotification(notificationItem);
    ...
    private void displayNotifications() {
        ...
        List<NotificationItemFYEE> notifications = NotificationManagerFYEE.getInstance(FyEEOptionActivity.this).getNotifications();
