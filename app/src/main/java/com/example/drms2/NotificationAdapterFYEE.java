...
public class NotificationAdapterFYEE extends ArrayAdapter<NotificationItemFYEE> {

    private Context context;
    private List<NotificationItemFYEE> notificationList;

    public NotificationAdapterFYEE(Context context, List<NotificationItemFYEE> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemFYEE notificationItem = notificationList.get(position);
