...
public class NotificationAdapterFYEJ extends ArrayAdapter<NotificationItemFYEJ> {

    private Context context;
    private List<NotificationItemFYEJ> notificationList;

    public NotificationAdapterFYEJ(Context context, List<NotificationItemFYEJ> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemFYEJ notificationItem = notificationList.get(position);
