...
public class NotificationAdapterFYAE extends ArrayAdapter<NotificationItemFYAE> {

    private Context context;
    private List<NotificationItemFYAE> notificationList;

    public NotificationAdapterFYAE(Context context, List<NotificationItemFYAE> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemFYAE notificationItem = notificationList.get(position);
