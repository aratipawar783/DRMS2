...
public class NotificationAdapterTYCM extends ArrayAdapter<NotificationItemTYCM> {

    private Context context;
    private List<NotificationItemTYCM> notificationList;

    public NotificationAdapterTYCM(Context context, List<NotificationItemTYCM> notificationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NotificationItemTYCM notificationItem = notificationList.get(position);
