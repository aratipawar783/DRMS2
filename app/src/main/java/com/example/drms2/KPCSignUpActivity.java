...
public class KPCSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdminSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean b=dbHelper.validateKPC(username,confirm);
                if (b && (password.equals(confirm))) {
                    Toast.makeText(KPCSignUpActivity.this, "You have already created an account...!", Toast.LENGTH_SHORT).show();
                    etxtConfirmPassword.setText("");
                    etxtPassword.setText("");
                    etxtUser.setText("");
                }else {
                    boolean b1 = dbHelper.insertKPCSignup(username, confirm);
                    if (b1 && (password.equals(confirm))) {
                        Toast.makeText(KPCSignUpActivity.this, "Sign_up Successful...!", Toast.LENGTH_SHORT).show();
                        etxtConfirmPassword.setText("");
                        etxtPassword.setText("");
                        etxtUser.setText("");
                        Intent intent=new Intent(KPCSignUpActivity.this, MainDashboardActivity.class);
                        startActivity(intent);
                    }else
                    {
                        Toast.makeText(KPCSignUpActivity.this, "Sign-up Unsuccessful..!", Toast.LENGTH_SHORT).show();
